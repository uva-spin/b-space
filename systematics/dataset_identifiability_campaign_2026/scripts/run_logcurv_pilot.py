#!/usr/bin/env python3
"""Run one isolated global log-FNP-curvature regularization pilot."""
...
def arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--lambda-logcurv", type=float, required=True)
...
def main() -> None:
    ...
    try:
        ...
        lock.rmdir()
    print(json.dumps({
        "status": "complete", "tag": tag, "seed": seed,
        "lambda_logcurv": args.lambda_logcurv,
    }))
