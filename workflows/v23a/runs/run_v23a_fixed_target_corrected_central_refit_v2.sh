...
# v23a fixed-target low-Q central refit with E772 included and E288_300:99 corrected.
#
# Uses the cached external W/Y grids built by run_v23a_fixed_target_checkonly_cache.sh.
# Run from ~/work/bT-TMD.
#
# Default output:
#   outputs/v23a_fixed_target_lowQ_corrected_central_refit_s303
...
DATA_DIR="${DATA_DIR:-${ROOT}/Data/v23a_fixed_target_lowQ_row99_variants/corrected_E288_300_99}"
...
OUT="${OUT:-${ROOT}/outputs/v23a_fixed_target_lowQ_corrected_central_refit_s303}"
DEVICE="${DEVICE:-cuda}"
SEED="${SEED:-303}"
...
echo
echo "v23a central refit complete."
echo "Audit with:"
echo "  PYTHONPATH=. python3 v23/tools/audit_v23a_central_refit.py \\"
echo "    --run '${OUT}' \\"
echo "    --v22-run '${ROOT}/outputs/v22_full_backend_central_refit_stage1_s303' \\"
echo "    --out '${ROOT}/v23/outputs/v23a_central_refit_audit_s303'"
