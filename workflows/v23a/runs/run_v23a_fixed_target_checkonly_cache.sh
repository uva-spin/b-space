...
# v23a fixed-target low-Q check-only backend cache build.
#
# Run after build_v23a_fixed_target_from_verified_data.py.
#
# This builds the perturbative W/Y cache once for:
#   E288_200 E288_300 E288_400 E605 E772
#
# It is expected to be CPU-bound and slower than v22 because it has more rows.
...
DATA_DIR="${DATA_DIR:-${ROOT}/Data/v23a_fixed_target_lowQ_verified}"
OUT="${OUT:-${ROOT}/outputs/v23a_fixed_target_lowQ_checkonly_cache}"
CACHE_TAG="${CACHE_TAG:-v23a_fixedtarget_E288_E605_E772_v22full_n3llp_nloQ96_b160}"
...
echo
echo "v23a check-only cache build complete."
echo "Inspect:"
