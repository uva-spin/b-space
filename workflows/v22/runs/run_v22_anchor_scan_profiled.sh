...
#
# Optional:
#   ANCHORS="30 10" SEEDS="1001 1002 1003" MAX_PARALLEL=1 ./workflows/v22/runs/run_v22_anchor_scan_profiled.sh
...
echo "  (use the campaign-specific postprocessor recorded in the output manifest)"
