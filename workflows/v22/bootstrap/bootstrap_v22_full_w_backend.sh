...
# Create a non-destructive v22 backend that upgrades both W and Y.
# Run from ~/work/bT-TMD.

ROOT="$(pwd)"
SOURCE="${ROOT}/v22/backends/bt_internal_css_backend_v22_scheme_y.py"
OUT="${ROOT}/v22/backends/bt_internal_css_backend_v22_full.py"
...
spec = importlib.util.spec_from_file_location(
    "v22_full_backend_smoke",
    str(path),
)

if spec is None or spec.loader is None:
    raise SystemExit("could not import full v22 backend")

module = importlib.util.module_from_spec(spec)
sys.modules[spec.name] = module
spec.loader.exec_module(module)

assert module.V22_FULL_PERTURBATIVE_BACKEND_ACTIVE
assert module.V22_SCHEME_CONSISTENT_Y_ACTIVE
assert hasattr(module, "wpert_cs_for_row")
assert hasattr(module, "singular_nlo_dev_for_row")
assert hasattr(module, "compute_backend_grids")

print("v22 full W+Y backend import passed")
print("W organization:", module.V22_W_ORGANIZATION)
PY

echo
echo "Created:"
echo "  v22/backends/bt_internal_css_backend_v22_full.py"
