...
$$
\begin{aligned}
b_0 = 2e^{-\gamma_E},\qquad \mu_b=\frac{b_0}{b_T},\qquad \zeta_b=\mu_b^2.
\end{aligned}
$$
...
$$
\begin{aligned}
\widetilde f_{q/H}(x,b_T;\mu_b,\zeta_b) = \sum_j \left[ \widetilde C_{q/j}\otimes f_{j/H} \right](x,\mu_b) +\mathcal O(b_T^2\Lambda_{\rm QCD}^2).
\end{aligned}
$$
...
$$
\begin{aligned}
\widetilde C_{q/q}(z) = \delta(1-z) + a_s C_F \left[ -\frac{\pi^2}{6}\delta(1-z) + 2(1-z) \right],
\end{aligned}
$$

$$
\begin{aligned}
\widetilde C_{q/g}(z) = a_s 2z(1-z),
\end{aligned}
$$
...
$$
\begin{aligned}
(C\otimes f)(x) = \int_x^1\frac{dz}{z} C(z)f(x/z).
\end{aligned}
$$
