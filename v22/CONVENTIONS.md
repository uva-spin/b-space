...
the $k_T$-space TMD has units of $\mathrm{GeV}^{-2}$.

## Fourier convention

$$
\begin{aligned}
\widetilde f(x,\boldsymbol b_T) = \int d^2\boldsymbol k_T e^{+i\boldsymbol k_T\cdot\boldsymbol b_T} f(x,\boldsymbol k_T),
\end{aligned}
$$

$$
\begin{aligned}
f(x,\boldsymbol k_T) = \int\frac{d^2\boldsymbol b_T}{(2\pi)^2} e^{-i\boldsymbol k_T\cdot\boldsymbol b_T} \widetilde f(x,\boldsymbol b_T).
\end{aligned}
$$
...
$$
\begin{aligned}
f(x,k_T) = \frac{1}{2\pi} \int_0^\infty db_T b_T J_0(k_Tb_T)\widetilde f(x,b_T).
\end{aligned}
$$
...
$$
\begin{aligned}
\int d^2\boldsymbol k_T f(x,k_T) = \widetilde f(x,b_T=0)
\end{aligned}
$$
...
$$
\begin{aligned}
W(q_T) = \frac{1}{2\pi} \int_0^\infty db_T b_T J_0(q_Tb_T) \widetilde W(b_T).
\end{aligned}
$$
...
$$
\begin{aligned}
\widetilde W(b_T) = H_{\rm DY} \sum_q e_q^2 \left[ \widetilde f_{q/A}(x_1,b_T) \widetilde f_{\bar q/B}(x_2,b_T) + \widetilde f_{\bar q/A}(x_1,b_T) \widetilde f_{q/B}(x_2,b_T) \right].
\end{aligned}
$$
...
$$
\begin{aligned}
C = \delta + \sum_{n\ge1}a_s^n C^{(n)},\qquad H = 1 + \sum_{n\ge1}a_s^n H^{(n)}.
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{d\ln \widetilde f}{d\ln\sqrt{\zeta}} = K(b_T;\mu),
\end{aligned}
$$

$$
\begin{aligned}
\frac{dK(b_T;\mu)}{d\ln\mu} = -\gamma_K(\alpha_s).
\end{aligned}
$$
...
$$
\begin{aligned}
F_{\rm NP}(x,0)=1,\qquad F_{\rm NP}(x,b_T)=1+\mathcal O(b_T^2\Lambda_{\rm QCD}^2).
\end{aligned}
$$
