...
def main() -> None:
    ...
    ax.text(
        0.035,
        0.955,
        rf"$x={args.x:g},\quad Q={args.Q:g}\,\mathrm{{GeV}}$",
    ...
    ax.text(
        0.035,
        0.885,
        r"shaded: 68\% experimental+PDF overlay",
        transform=ax.transAxes,
        ha="left",
        va="top",
        fontsize=10.5,
    ...
    summary = {
        ...
        "yscale": args.yscale,
        "uncertainty": "q16--q84 experimental+PDF overlay",
