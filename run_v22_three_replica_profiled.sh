...
#
# Optional overrides:
#   SEEDS="1001 1002 1003" ./run_v22_three_replica_profiled.sh
#   MAX_PARALLEL=2 ./run_v22_three_replica_profiled.sh
#   CENTRAL_RUN=/path/to/central_refit ./run_v22_three_replica_profiled.sh
#   TRAIN=/path/to/train_bt_dnn_v21_replica_stable.py ./run_v22_three_replica_profiled.sh
#   PREP=/path/to/prepare_v21_replica_norm_inits.py ./run_v22_three_replica_profiled.sh
