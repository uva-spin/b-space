...
Version 2 recognizes the common A/dA convention: A is the measured
observable and dA is its uncertainty.
...
def main() -> None:
    ...
    manifest = {
        ...
        "notes": [
            ...
            "Column alias update: A is treated as the measured observable and dA as its total uncertainty when present.",
