...
# v23a fixed-target low-Q central refit, corrected E288_300:99, using CSV
# normalization/P2P metadata.  This is intended to fix the gigantic E772 norm
# pull seen when --norm-source paper does not know E772.
#
...
OUT="${OUT:-${ROOT}/outputs/v23a_fixed_target_lowQ_corrected_central_refit_csvnorm_s303}"
DEVICE="${DEVICE:-cuda}"
SEED="${SEED:-303}"
...
echo
echo "v23a CSV-norm central refit complete."
echo "Audit with:"
echo "  PYTHONPATH=. python3 v23/tools/audit_v23a_central_refit_v2.py \\"
echo "    --run '${OUT}' \\"
echo "    --v22-run '${ROOT}/outputs/v22_full_backend_central_refit_stage1_s303' \\"
echo "    --out '${ROOT}/v23/outputs/v23a_central_refit_csvnorm_audit_s303'"
